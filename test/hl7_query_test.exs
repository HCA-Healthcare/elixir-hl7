defmodule HL7QueryTest do
  ...
  test "extract multiple segment values from the sub-selected segments" do
    parts = new(@wiki) |> select("OBX") |> get_parts("1")
    assert parts == ["1", "2"]
  end
