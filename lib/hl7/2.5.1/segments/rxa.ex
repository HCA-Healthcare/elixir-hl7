defmodule HL7.V2_5_1.Segments.RXA do
  @moduledoc false
  ...
  use HL7.Segment,
    fields: [
      segment: nil,
			...
			administered_drug_strength_volume: nil,
			administered_drug_strength_volume_units: DataTypes.Cwe,
			administered_barcode_identifier: DataTypes.Cwe,
