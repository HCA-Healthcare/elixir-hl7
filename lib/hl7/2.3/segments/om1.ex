defmodule HL7.V2_3.Segments.OM1 do
  @moduledoc """
  ...
  use HL7.Segment,
    fields: [
      ...
      observation_description: DataTypes.Ce,
      ...
      orderability: nil,
      identity_of_instrument_used_to_perfrom_this_study: DataTypes.Ce,
      ...
      date_time_stamp_for_any_change_in_def_attri_for_obs: DataTypes.Ts,
      effective_date_time_of_change_in_test_proc_that_make_results_non_comparable: DataTypes.Ts,
